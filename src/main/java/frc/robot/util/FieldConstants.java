...
public class FieldConstants {
  public static final double fieldLength = DriveConstants.aprilTagLayout.getFieldLength();
  public static final double fieldWidth = DriveConstants.aprilTagLayout.getFieldWidth();
  ...
  public static class Processor {
    public static final Pose2d centerFace =
        new Pose2d(
            DriveConstants.aprilTagLayout.getTagPose(16).get().getX(),
            0,
  ...
  public static class Reef {
    ...
    static {
      // Initialize faces
      var aprilTagLayout = DriveConstants.aprilTagLayout;
